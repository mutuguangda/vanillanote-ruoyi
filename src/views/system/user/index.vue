  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户昵称" align="center" key="nickName" prop="nickName" v-if="columns[2].visible"
        :show-overflow-tooltip="true" />
      <el-table-column label="邮箱" align="center" key="email" prop="email" v-if="columns[4].visible" width="240" />
      ...
      <el-table-column label="创建时间" align="center" prop="createdTime" v-if="columns[6].visible" width="200">
        <template slot-scope="scope">
        ...
        <template slot-scope="scope" v-if="scope.row.userId !== 1">
          ...
          <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)"
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="handleResetPwd" icon="el-icon-key" v-hasPermi="['system:user:resetPwd']">重置密码
              </el-dropdown-item>
