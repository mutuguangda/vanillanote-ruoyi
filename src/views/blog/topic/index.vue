<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="专题作者" prop="createdBy">
        <el-input
      ...
      <el-form-item label="专题标签" prop="tag">
        <el-select v-model="queryParams.tag" placeholder="专题标签" clearable>
          <el-option
      ...
      <el-form-item label="专题专题" prop="topic">
        <el-input
    ...
    <el-table v-loading="loading" :data="topicList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="专题标题" align="center" prop="title" :show-overflow-tooltip="true" width="240" />
      <el-table-column label="专题文章" align="center" prop="articles" :show-overflow-tooltip="true" />
      <el-table-column label="文章数目" align="center" prop="articlesNum" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="专题作者" prop="createdBy">
          <el-input v-model="form.createdBy" placeholder="请输入专题作者" />
        </el-form-item>
        <el-form-item label="专题键值" prop="topicValue">
          <el-input v-model="form.topicValue" placeholder="请输入专题键值" />
        </el-form-item>
        <el-form-item label="专题标签" prop="tag">
...
<script>
import { listTopic, getTopic, delTopic, addTopic, updateTopic, syncTopic } from "@/api/blog/topic";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        topicValue: [
          { required: true, message: "专题键值不能为空", trigger: "blur" }
        ]
      },
      // 同步时间
      syncTime: ''
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listTopic(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
    ...
    submitForm: function() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.topicId != undefined) {
